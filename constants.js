...
const catalog = [
  ...
  },
  {
    ...
    name: 'Фусили в Сливочно-грибнсом соусе',
    description: '*Фусили в Сливочно-грибнсом соусе* \nФусили, Альфредо соус, грибы, пармезан, чеснок \n\nСредний 25сом \nБольшой 30сом \nCемейный 35сом',
  ...
  },
  {
    ...
    name: 'Картофель фри с пармезансом',
    description: '*Картофель фри с пармезансом* \nКартофель, соль, пармезан \n\nСредний 25сом \nБольшой 35сом \nCемейный 40сом ',
    price: {price1: 25, price2: 35, price3: 40}
  },
  {
    category: 'Гарниры 🍟',
    ...
    name: 'Картофель фри с чесноксом',
    description: '*Картофель фри с чесноксом* \nКартофель, соль, чеснок \n\nСредний 25сом \nБольшой 35сом \nCемейный 40сом ',
    price: {price1: 25, price2: 35, price3: 40}
  },
  {
    category: 'Гарниры 🍟',
